...
defined('PROVISIONING_API_TOKEN_SECOND_PROJECT')
	|| define('PROVISIONING_API_TOKEN_SECOND_PROJECT', getenv('PROVISIONING_API_TOKEN_SECOND_PROJECT') ? getenv('PROVISIONING_API_TOKEN_SECOND_PROJECT') : 'token');
